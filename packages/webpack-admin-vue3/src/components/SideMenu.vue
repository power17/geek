    ...
    <aside
      ...
      <div class="flex flex-row w-full flex-1 h-14 items-center dark:bg-transparent bg-gray-900 text-white">
        <div class="hidden lg:flex xl:hidden items-center grow-0 shrink-0 relative cursor-pointer text-white py-2 px-3">
          <span class="inline-flex justify-center items-center w-6 h-6 cursor-pointer"
            ><svg viewBox="0 0 24 24" width="24" height="24" class="inline-block">
              <path fill="currentColor" d="M3,6H21V8H3V6M3,11H21V13H3V11M3,16H21V18H3V16Z"></path></svg
          ></span>
        </div>
      ...
      <div>
        ...
        <ul>
          <li>
            ...
            <router-link
              ...
              aria-current="page"
              to="/"
              ><span class="inline-flex justify-center items-center w-12 h-6 flex-none font-bold text-white"
        ...
        <ul>
          <li v-for="(item, index) in courses" :key="index">
            ...
            <router-link class="flex cursor-pointer dark:hover:bg-gray-700/50 hover:bg-gray-600 hover:bg-opacity-50 py-2" :to="item.url"
              ><span class="inline-flex justify-center items-center w-12 h-6 flex-none text-gray-300"><i :class="item.icon"></i></span
        ...
        <ul>
          <li>
            <a
              ...
              ><span class="inline-flex justify-center items-center w-12 h-6 flex-none text-gray-300"><i class="i-mdi-github"></i></span
